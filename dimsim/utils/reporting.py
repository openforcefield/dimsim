...
def print_potential_summary(potential: dimsim.TensorPotential):
...
def print_v_site_summary(v_sites: dimsim.TensorVSites):
    import pandas
...
def print_force_field_summary(force_field: dimsim.TensorForceField):
