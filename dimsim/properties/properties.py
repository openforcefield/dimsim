...
from dimsim.layers.equilibration import EquilibrationProperty, EquilibrationSchema
from dimsim.layers.preequilibrated_simulation import PreequilibratedSimulationSchema
from dimsim.layers.reweighting import ReweightingSchema
from dimsim.layers.simulation import SimulationSchema
from dimsim.protocols import analysis, miscellaneous
...
from dimsim.storage.query import (
    EquilibrationDataQuery,
    SimulationDataQuery,
    SubstanceQuery,
)
from dimsim.utils.observables import ObservableType
from dimsim.workflow.attributes import ConditionAggregationBehavior
from dimsim.workflow.schemas import ProtocolReplicator, WorkflowSchema
from dimsim.workflow.utils import ProtocolPath, ReplicatorValue
...
class EstimableExcessProperty(PhysicalProperty, abc.ABC):
    ...
    def _default_reweighting_schema(
        ...
        weight_by_mole_fraction.full_substance = ProtocolPath(
            "substance", mixture_protocols.build_reference_system.id
        )
        weight_by_mole_fraction.component = component_substance
