...
def topology_to_rdkit(topology: dimsim.TensorTopology) -> Chem.Mol:
    """Convert a topology to an RDKit molecule."""
    mol = Chem.RWMol()

    for atomic_num, formal_charge in zip(topology.atomic_nums, topology.formal_charges, strict=True):
